...
if s:configuration.enable_italic
  ...
  call everforest#highlight('Repeat', s:palette.aqua, s:palette.none, 'italic')
  ...
  call everforest#highlight('Repeat', s:palette.aqua, s:palette.none)
...
if s:configuration.enable_italic
  ...
  call everforest#highlight('GreyItalic', s:palette.grey1, s:palette.none, 'italic')
else
